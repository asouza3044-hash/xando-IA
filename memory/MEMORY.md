...
- [Material/máquina/markup por cliente](referencia_material_maquina_por_cliente.md) — padrão dos 54 orçamentos (MICROGEAR aço MP-cliente, R2=D760, SPEEDMAQ válvula=alumínio+D760). Sanity-check, NUNCA substitui desenho
- [**Mineração completa 54 orçamentos**](projeto_mineracao_orcamentos.md) — achou 3 códigos inventados (027/028/029/014), calibração as-built, padrões por cliente. Base calibrada
