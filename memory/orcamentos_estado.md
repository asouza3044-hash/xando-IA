...
- **FECHADO COM CLIENTE (10/08/2026):** Alexandre passou pro cliente **150 peças a R$3,92/pç = R$588,00** (subiu de 150 vs. os 100 recomendados, manteve o preço unitário — margem real ainda melhor, ~25% em vez de 19%, já que o custo real em 150pç é menor que em 100pç). PROPOSTA_COMERCIAL atualizada para refletir o fechamento real.
- Break-even original: pra cravar R$3,00/pç flat sem prejuízo, mínimo técnico seria 134pç (Fixos R$72,26 com CIF ÷ margem R$0,54/pç). Piso teórico (lote infinito): R$3,03/pç. Reposições na proposta: 200pç R$3,48 | 500pç R$3,21.
- **Custo fixo revisado:** R$57,81/lote (R$72,26 com CIF) = Setup 0,25h (R$36,13) + Programação 0,15h (R$21,68). Custo variável: R$1,9645/pç (R$2,46 com CIF).
- **Estado:** orçamento fechado, proposta enviada e aprovada em termos (150pç/R$3,92). Sincronizado nos 3 destinos externos (GitHub commit cc94b41, VM Oracle, OneDrive) — falta só re-sincronizar após esta última edição (150pç) se solicitado.
