...
console.log('═══════════════════════════════════════════════════════════');
console.log('📄 GERANDO HTMLs DO ORÇAMENTO 007/2025');
console.log('═══════════════════════════════════════════════════════════\n');
...
const orc = {
    ...
    // Custos MOD
    custoHoraMOD: 46.875, // R$/hora
    custoMODUnitario: 7.50, // R$ (9.6 min * 46.875 / 60)
    custoMODTotal: 67.50, // R$ (7.50 x 9)

    // Custos indiretos (58%)
    percentualIndiretos: 58,
    custoIndiretosUnitario: 4.35, // R$ (7.50 x 0.58)
    custoIndiretosTotal: 39.15, // R$ (4.35 x 9)

    // Custo total
    custoUnitario: 11.85, // R$ (7.50 + 4.35)
    custoTotal: 106.65, // R$ (11.85 x 9)
    ...
    // Preços
    precoSemImpostos: 15.29, // R$ (11.85 x 1.290)
    valorImpostos: 1.40, // R$ (15.29 x 0.085)
    precoUnitario: 16.69, // R$ (15.29 + 1.40)
    precoTotal: 150.21, // R$ (16.69 x 9)

    // Lucro
    lucroUnitario: 3.44, // R$ (16.69 - 11.85 - 1.40)
    lucroTotal: 30.96, // R$ (3.44 x 9)
    margemLiquida: 20.6, // % (3.44 / 16.69 * 100)
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tr>
                        <td>Custo/hora MOD</td>
                        <td style="text-align: right;">R$ ${orc.custoHoraMOD.toFixed(2)}/h</td>
            ...
            <div class="section">
                ...
                <div class="destaque">
                    ...
                    <ul style="margin-top: 10px; padding-left: 20px;">
                        ...
                        <li>Ferramental e consumíveis</li>
                        <li>Depreciação de equipamentos</li>
                        <li>Custos administrativos rateados</li>
                    </ul>
                </div>
            </div>
...
// Copiar para área de trabalho para fácil acesso
